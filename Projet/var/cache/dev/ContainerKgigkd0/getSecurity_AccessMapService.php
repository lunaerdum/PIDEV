...
$instance->add(new \Symfony\Component\HttpFoundation\RequestMatcher('^/pageFournisseur/'), [0 => 'ROLE_FOURNISSEUR'], NULL);
$instance->add(new \Symfony\Component\HttpFoundation\RequestMatcher('^/pageClient/'), [0 => 'ROLE_CLIENT'], NULL);
