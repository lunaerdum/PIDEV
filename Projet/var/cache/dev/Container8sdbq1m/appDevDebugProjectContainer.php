...
class appDevDebugProjectContainer extends Container
{
    ...
    public function __construct(array $buildParameters = [], $containerDir = __DIR__)
    {
        ...
        $this->fileMap = [
            ...
            'miracode_stripe.model_transformer.annotation' => 'getMiracodeStripe_ModelTransformer_AnnotationService.php',
        ...
        $this->privates = [
            ...
            'logger' => true,
            'miracode_stripe.model_transformer.annotation' => true,
    ...
    {
        $a = new \Symfony\Component\Cache\Adapter\FilesystemAdapter('r0EH-RZ9t7', 0, ($this->targetDirs[0].'/pools'));
    ...
    {
        return $this->services['cache.system'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('V-GRi76eRt', 0, $this->getParameter('container.build_id'), ($this->targetDirs[0].'/pools'), ${($_ = isset($this->services['monolog.logger.cache']) ? $this->services['monolog.logger.cache'] : $this->getMonolog_Logger_CacheService()) && false ?: '_'}));
    }
    ...
    {
        return $this->services['cache.annotations'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('UeSO31jW1f', 0, $this->getParameter('container.build_id'), ($this->targetDirs[0].'/pools'), ${($_ = isset($this->services['monolog.logger.cache']) ? $this->services['monolog.logger.cache'] : $this->getMonolog_Logger_CacheService()) && false ?: '_'}));
    }
    ...
    {
        return $this->services['cache.serializer'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('iWhyzvSDFa', 0, $this->getParameter('container.build_id'), ($this->targetDirs[0].'/pools'), ${($_ = isset($this->services['monolog.logger.cache']) ? $this->services['monolog.logger.cache'] : $this->getMonolog_Logger_CacheService()) && false ?: '_'}));
    }
    ...
    {
        return $this->services['cache.validator'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('DB7gXD65ta', 0, $this->getParameter('container.build_id'), ($this->targetDirs[0].'/pools'), ${($_ = isset($this->services['monolog.logger.cache']) ? $this->services['monolog.logger.cache'] : $this->getMonolog_Logger_CacheService()) && false ?: '_'}));
    }
    ...
    protected function getTwig_LoaderService()
    {
        ...
        $instance->addPath(($this->targetDirs[3].'\\src\\UserBundle/Resources/views'), '!User');
        $instance->addPath(($this->targetDirs[3].'\\src\\CategorieBundle/Resources/views'), 'Categorie');
        $instance->addPath(($this->targetDirs[3].'\\src\\CategorieBundle/Resources/views'), '!Categorie');
        $instance->addPath(($this->targetDirs[3].'\\src\\ProduitBundle/Resources/views'), 'Produit');
        $instance->addPath(($this->targetDirs[3].'\\src\\ProduitBundle/Resources/views'), '!Produit');
    ...
    private function getDynamicParameter($name)
    {
        switch ($name) {
            ...
            case 'kernel.bundles_metadata': $value = [
                ...
                'CategorieBundle' => [
                    'parent' => NULL,
                    'path' => ($this->targetDirs[3].'\\src\\CategorieBundle'),
                    'namespace' => 'CategorieBundle',
                ],
                'ProduitBundle' => [
                    'parent' => NULL,
                    'path' => ($this->targetDirs[3].'\\src\\ProduitBundle'),
                ...
                'MiracodeStripeBundle' => [
                    'parent' => NULL,
                    'path' => ($this->targetDirs[3].'\\vendor\\miracode\\stripe-bundle'),
    ...
    protected function getDefaultParameters()
    {
        return [
            ...
            'kernel.bundles' => [
                ...
                'CategorieBundle' => 'CategorieBundle\\CategorieBundle',
                'ProduitBundle' => 'ProduitBundle\\ProduitBundle',
                'StockBundle' => 'StockBundle\\StockBundle',
                'PanierBundle' => 'PanierBundle\\PanierBundle',
                'MiracodeStripeBundle' => 'Miracode\\StripeBundle\\MiracodeStripeBundle',
            ...
            'fos_user.registration.confirmation.from_email' => [
                'beya@mgmail.com' => 'beya@mgmail.com',
            ],
            ...
            'miracode_stripe.secret_key' => 'pk_test_FnGZrHBZq08iJQcGP6I6vvhT00DF6m4ScT',
