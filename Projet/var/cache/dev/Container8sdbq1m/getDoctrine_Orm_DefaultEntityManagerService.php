...
$c = new \Doctrine\ORM\Mapping\Driver\AnnotationDriver(${($_ = isset($this->services['annotation_reader']) ? $this->services['annotation_reader'] : $this->getAnnotationReaderService()) && false ?: '_'}, [0 => ($this->targetDirs[3].'\\src\\UserBundle\\Entity'), 1 => ($this->targetDirs[3].'\\src\\CategorieBundle\\Entity'), 2 => ($this->targetDirs[3].'\\src\\ProduitBundle\\Entity'), 3 => ($this->targetDirs[3].'\\src\\PanierBundle\\Entity')]);

$b->addDriver($c, 'UserBundle\\Entity');
$b->addDriver($c, 'CategorieBundle\\Entity');
$b->addDriver($c, 'ProduitBundle\\Entity');
...
$b->addDriver(new \Doctrine\ORM\Mapping\Driver\XmlDriver(new \Doctrine\Common\Persistence\Mapping\Driver\SymfonyFileLocator([($this->targetDirs[3].'\\vendor\\miracode\\stripe-bundle\\Resources\\config\\doctrine\\model') => 'Miracode\\StripeBundle\\Model'], '.orm.xml')), 'Miracode\\StripeBundle\\Model');

$a->setEntityNamespaces(['UserBundle' => 'UserBundle\\Entity', 'CategorieBundle' => 'CategorieBundle\\Entity', 'ProduitBundle' => 'ProduitBundle\\Entity', 'PanierBundle' => 'PanierBundle\\Entity']);
