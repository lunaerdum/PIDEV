 ...
 */
class Promotion extends \ProduitBundle\Entity\Promotion implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'ProduitBundle\\Entity\\Promotion' . "\0" . 'id', '' . "\0" . 'ProduitBundle\\Entity\\Promotion' . "\0" . 'valeur', '' . "\0" . 'ProduitBundle\\Entity\\Promotion' . "\0" . 'datef', '' . "\0" . 'ProduitBundle\\Entity\\Promotion' . "\0" . 'id_produit'];
        }
    ...
    public function setIdProduit($id_produit)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'setIdProduit', [$id_produit]);

        return parent::setIdProduit($id_produit);
    }
