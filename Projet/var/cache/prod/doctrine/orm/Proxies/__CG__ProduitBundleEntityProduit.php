...
namespace Proxies\__CG__\ProduitBundle\Entity;

/**
 * DO NOT EDIT THIS FILE - IT WAS CREATED BY DOCTRINE'S PROXY GENERATOR
 */
class Produit extends \ProduitBundle\Entity\Produit implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'ProduitBundle\\Entity\\Produit' . "\0" . 'id', '' . "\0" . 'ProduitBundle\\Entity\\Produit' . "\0" . 'nom', '' . "\0" . 'ProduitBundle\\Entity\\Produit' . "\0" . 'marque', '' . "\0" . 'ProduitBundle\\Entity\\Produit' . "\0" . 'prix', '' . "\0" . 'ProduitBundle\\Entity\\Produit' . "\0" . 'quantite', '' . "\0" . 'ProduitBundle\\Entity\\Produit' . "\0" . 'id_categorie', 'file', 'nomfile'];
        }

        return ['__isInitialized__', '' . "\0" . 'ProduitBundle\\Entity\\Produit' . "\0" . 'id', '' . "\0" . 'ProduitBundle\\Entity\\Produit' . "\0" . 'nom', '' . "\0" . 'ProduitBundle\\Entity\\Produit' . "\0" . 'marque', '' . "\0" . 'ProduitBundle\\Entity\\Produit' . "\0" . 'prix', '' . "\0" . 'ProduitBundle\\Entity\\Produit' . "\0" . 'quantite', '' . "\0" . 'ProduitBundle\\Entity\\Produit' . "\0" . 'id_categorie', 'file'];
    }
