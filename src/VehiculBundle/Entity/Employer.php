 ...
 * @ORM\Entity(repositoryClass="VehiculBundle\Repository\EmployerRepository")
 */
class Employer
{
    /**
    ...
    /**
     * @var \VehiculBundle\Entity\Type
     *
     * @ORM\ManyToOne(targetEntity="VehiculBundle\Entity\Type")
     * @ORM\JoinColumns({
